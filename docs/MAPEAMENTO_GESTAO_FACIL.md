...
|------|--------|-------------|-------|
| **0 — Schema base** | 🟡 Em andamento | `cursor/gf-fase0-base-fdca` | `empresa_config`, cadastros auxiliares, colunas fiscais nullable em `produtos` |
| 1 — Cadastros | ⚪ Pendente | — | Pessoas, extensão produtos |
